      ...
      <div className="px-5 pb-6 md:px-6">
        <div className="mb-3 flex items-start justify-between gap-3">
          <div className="flex items-center gap-3">
            ...
            <div>
              <h3 className="m-0 text-sm font-bold text-neutral-800">
                {course.author}
              </h3>
        ...
        <div className="mb-6 space-y-2.5">
          {course.milestones.map((milestone) => (
            <div
              key={milestone.id}
              className="flex items-center gap-3 border-b border-neutral-100 pb-2"
            >
        ...
        <div className="mb-6 flex flex-wrap gap-2">
          {course.tags.map((tag) => (
            <span
              key={tag}
              className="rounded border border-neutral-300 px-3 py-1 text-[8px] text-neutral-500"
            >
              {tag}
            </span>
          ))}
        ...
        <div className="flex rounded-xl items-center justify-between gap-3 pt-1 border border-neutral-200 px-4 py-2">
          <p className="m-0 text-sm font-bold leading-none text-neutral-900">
            {course.priceMain}
          </p>

          <Button
            variant="ghost"
            className="flex-col text-[10px] items-start rounded-xl border border-neutral-200 px-2 py-2 text-left"
          >
  ...
  return (
    <section className="mt-8 md:p-8">
      ...
      <p className="mx-auto mt-2 max-w-[64ch] text-center text-secondary">
        Choose a track, follow practical milestones, and build work-ready
        confidence through guided projects.
      </p>
