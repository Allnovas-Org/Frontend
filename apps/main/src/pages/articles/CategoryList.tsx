    ...
    <article className='w-full min-h-screen bg-white py-20 md:py-24 lg:py-32 px-4 md:px-6'>
      <div className='max-w-6xl mx-auto'>
        ...
        <div className='flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4 md:gap-6 mb-8 md:mb-12'>
          {/* Left: Back Button with "Article" Label */}
          <button
            onClick={onBack}
        ...
        <div className='px-0 md:px-36 lg:px-32'>
          {/* Title */}
          <h2 className='text-2xl md:text-3xl lg:text-4xl font-semibold text-gray-darker'>
            {title}
          </h2>
          <p className='text-sm md:text-base text-gray-dark mb-8 md:mb-12'>
            {subtitle}
          </p>
          ...
          {filteredArticles.length > 0 ? (
            ...
            <div className='text-center py-12'>
              ...
              <p className='text-input text-sm mt-2'>
