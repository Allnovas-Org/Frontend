		...
		<div className="w-full">
			...
			<div className="bg-linear-to-br from-[#111111] via-[#1E1D1A] to-[#1C3843] py-16 md:py-20 px-4 md:px-5">
				<div className="max-w-6xl mx-auto">
					<motion.div
						className="flex flex-col items-center max-w-4xl w-full mx-auto mb-8"
						initial={{ opacity: 0, y: 20 }}
						whileInView={{ opacity: 1, y: 0 }}
						viewport={{ once: true, amount: 0.3 }}
						transition={{ duration: 0.6 }}
					>
						<h2 className="text-xl lg:text-3xl text-center font-semibold mb-3 text-white w-fit relative">
							Build Templates. Download Free. Grow Together
							{/* Arrow Image - Only visible on large screens */}
							<motion.img
								src={arrowDownImage}
								alt="Arrow pointing down"
								className="absolute top-5 -right-6 h-auto max-md:top-15 max-md:-right-2 max-md:max-w-4 max-w-7"
					...
					<div className="grid grid-cols-1 lg:grid-cols-2 gap-10 md:gap-12 lg:gap-20 items-center">
						...
						<div className="relative z-10 animate-fade-in-up">
							...
							<h2 className="text-xl md:text-2xl lg:text-3xl xl:text-4xl font-bold text-gray-900 mb-5 md:mb-6 leading-tight relative inline-block animate-fade-in">
								...
								/>
								<span className="relative inline-block">Our Community</span>
							</h2>
							<p className="text-gray-600 text-sm md:text-base lg:text-lg leading-relaxed mb-7 md:mb-9 max-w-xl animate-fade-in-up animation-delay-200">
								Where talents connect, collaborate and grow together. Find your
								space to learn, connect and grow
							</p>
						...
						<div className="relative animate-fade-in-right animation-delay-200">
							...
							<div className="absolute -top-8 -right-8 md:-top-12 md:-right-12 w-32 h-32 md:w-48 md:h-48 z-0">
								...
								<svg
									viewBox="0 0 100 100"
									className="absolute top-0 left-0 w-16 h-16 md:w-20 md:h-20 animate-twinkle"
								>
									<polygon
								...
								<svg
									viewBox="0 0 100 100"
									className="absolute bottom-4 right-4 w-12 h-12 md:w-16 md:h-16 animate-twinkle animation-delay-500"
								>
									<polygon
										points="50,15 53,28 67,28 56,36 59,49 50,42 41,49 44,36 33,28 47,28"
										fill="#DDD6FE"
									/>
								</svg>
							</div>
