...
const AddBilling: React.FC<AddBillingProps> = ({ open, onClose, onAdd }) => {
	...
	return (
		...
		>
			...
			<div className="flex items-start justify-between p-4 pb-2">
				<h2 className="text-xl font-semibold text-gray-900">New Card</h2>
			...
			<div className="px-6 pb-6 space-y-4">
				...
				<div className="flex gap-3 pt-2">
					...
					<button
						...
						className="flex-1 px-6 py-3 text-base text-white rounded-lg transition disabled:opacity-50 disabled:cursor-not-allowed"
